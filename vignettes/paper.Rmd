...
```{r missing-associations, include = FALSE, eval = regen_results}
if (regen_results) {
...
### Temporal trends in variable completeness

```{r explore-detection-time-variables, eval = FALSE}
# Miss data ---------------------------------------------------------------
...
## Data completeness - additional results tables
...
ETSMissing::pull_results(results, "bcgvaccyr") %>% 
  knitr::kable(
        caption = pretty_suptabref("bcgvaccyr-miss", "Results from a logistic regression model with data completeness (Complete/Missing) for year of BCG vaccination as an outcome, adjusted for: year, sex, age (grouped 
...
ETSMissing::pull_results(results, "datediag") %>% 
  knitr::kable(
        caption = pretty_suptabref("datediag-miss", "Results from a logistic regression model with data completeness (Complete/Missing) for date of diagnosis onset as an 
...
ETSMissing::pull_results(results, "starttreatdate") %>% 
  knitr::kable(
      caption =  pretty_suptabref("starttreatdate-miss", "Results from a logistic regression model with data completeness (Complete/Missing) for date of starting
...
ETSMissing::pull_results(results, "txenddate") %>% 
  knitr::kable(
        caption = pretty_suptabref("txenddate-miss", "Results from a logistic regression model with data completeness (Complete/Missing) for date of starting treatment
...
ETSMissing::pull_results(results, "dateofdeath") %>% 
  knitr::kable(
        caption = pretty_suptabref("dateofdeath-miss", "Results from a logistic regression model with data completeness (Complete/Missing) for date of death as an outcome, adjusted for: year, sex, age (grouped as 
...
ETSMissing::pull_results(results, "tomdeathrelat") %>% 
  knitr::kable(
        caption = pretty_suptabref("tomdeathrealat-miss", "Results from a logistic regression model with data completeness (Complete/Missing) for cause of death as an outcome, adjusted for: year, 
