...
ETSMissing::pull_results(results, "bcgvacc") %>% 
  kable(
        caption = pretty_tabref("bcgvacc-miss", "Results from a logistic regression model with data completeness (Complete/Missing) for BCG vaccination as an outcome, adjusted for: year, sex, age (grouped as 0-14 
                                ...
                                explanatory variables. The model indicates that BCG status is missing at random for the variables considered."), booktabs = TRUE, longtable = TRUE) %>% 
...
ETSMissing::pull_results(results, "bcgvaccyr") %>% 
  kable(format = "latex",
        caption = pretty_tabref("bcgvaccyr-miss", "Results from a logistic regression model with data completeness (Complete/Missing) for year of BCG vaccination as an outcome, adjusted for: year, sex, age (grouped 
                                ...
                                explanatory variables. The model indicates that year of BCG vaccination is missing at random for the variables considered."), booktabs = TRUE, longtable = TRUE) %>% 
...
ETSMissing::pull_results(results, "tomdeathrelat") %>% 
  kable(
        caption = pretty_tabref("tomdeathrealat-miss", "Results from a logistic regression model with data completeness (Complete/Missing) for cause of death as an outcome, adjusted for: year, 
                                ...
                                other variables"), booktabs = TRUE, longtable = TRUE) %>% 
    kable_styling(font_size = 8, latex_options = c("repeat_header")) %>% 
    column_spec(c(1), width = "1.5cm") %>% 
    column_spec(c(4), width = "2cm") %>% 
    column_spec(c(6, 7), width = "1.5cm") %>% 
...
ETSMissing::pull_results(results, "symptonset") %>% 
  kable(
        caption = pretty_tabref("symptonset-miss", "Results from a logistic regression model with data completeness (Complete/Missing) for date of symptom onset as an outcome, adjusted for: 
                                ...
                                not at random for the variables for all variables considered, except for sex."), booktabs = TRUE, longtable = TRUE) %>% 
    kable_styling(font_size = 8, latex_options = c("repeat_header")) %>% 
    column_spec(c(1), width = "1.5cm") %>% 
    column_spec(c(4), width = "2cm") %>% 
    column_spec(c(6, 7), width = "1.5cm") %>% 
...
ETSMissing::pull_results(results, "datediag") %>% 
  kable(
        caption = pretty_tabref("datediag-miss", "Results from a logistic regression model with data completeness (Complete/Missing) for date of diagnosis onset as an 
                                ...
                                date of diagnosis is missing at random for the variables for all variables considered, except for sex."), booktabs = TRUE, longtable = TRUE) %>% 
    kable_styling(font_size = 8, latex_options = c("repeat_header")) %>% 
    column_spec(c(1), width = "1.5cm") %>% 
    column_spec(c(4), width = "2cm") %>% 
    column_spec(c(6, 7), width = "1.5cm") %>% 
...
kable(
      caption =  pretty_tabref("starttreatdate-miss", "Results from a logistic regression model with data completeness (Complete/Missing) for date of starting
                               ...
                               is associated with any variable considered, except for year of notification."), booktabs = TRUE, longtable = TRUE) %>% 
  kable_styling(font_size = 8, latex_options = c("repeat_header")) %>% 
  column_spec(c(1), width = "1.5cm") %>%   
  column_spec(c(4), width = "2cm") %>% 
  column_spec(c(6, 7), width = "1.5cm") %>% 
...
ETSMissing::pull_results(results, "txenddate") %>% 
  kable(
        caption = pretty_tabref("txenddate-miss", "Results from a logistic regression model with data completeness (Complete/Missing) for date of starting treatment
                                ...
                                associated with any variable considered, except for year of notification."), booktabs = TRUE, longtable = TRUE) %>% 
    kable_styling(font_size = 8, latex_options = c("repeat_header")) %>% 
    column_spec(c(1), width = "1.5cm") %>% 
    column_spec(c(4), width = "2cm") %>% 
    column_spec(c(6, 7), width = "1.5cm") %>% 
